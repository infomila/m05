...
public class CustomerTest extends TestCase {
	...
	public void testAddRental() {
		...
		Movie movie1 = new Movie("Gone with the Wind", MovieTypeEnum.REGULAR);
                //Movie movie1 = new MovieType_Regular("Gone with the Wind");
	...
	public void testStatementForNewReleaseMovie() {
		Customer customer2 = new Customer("Sallie");
    		Movie movie1 = new Movie("Star Wars", MovieTypeEnum.NEW_RELEASE);
                //Movie movie1 = new MovieType_NewRelease("Star Wars");
		Rental rental1 = new Rental(movie1, 3); // 3 day rental
		customer2.addRental(rental1);
		String expected = "Rental Record for Sallie\n" +
							"\tStar Wars\t9.0\n" +
	...
	public void testStatementForChildrensMovie() {
		...
		Movie movie1 = new Movie("Madagascar", MovieTypeEnum.CHILDRENS);
                //Movie movie1 = new MovieType_Children("Madagascar");
		Rental rental1 = new Rental(movie1, 3); // 3 day rental
		customer2.addRental(rental1);
		String expected = "Rental Record for Sallie\n" +
							"\tMadagascar\t1.5\n" +
	...
	public void testStatementForManyMovies() {
		...
		Movie movie2 = new Movie("Star Wars", MovieTypeEnum.NEW_RELEASE);
                //Movie movie2 = new MovieType_NewRelease("Star Wars");
		Rental rental2 = new Rental(movie2, 2); // 2 day rental
		Movie movie3 = new Movie("Gone with the Wind", MovieTypeEnum.REGULAR);
                //Movie movie3 = new MovieType_Regular("Gone with the Wind");
